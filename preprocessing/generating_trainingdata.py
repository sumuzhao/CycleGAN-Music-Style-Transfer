...
PATH_SEG = '/Users/sumuzhao/Downloads/MIDI/jazz/jazz_test/structure/labs'
ROOT_TRACKS = '/Users/sumuzhao/Downloads/MIDI/jazz/jazz_test/tracks'
PATH_INSTRU_ACT = join(ROOT_TRACKS, 'act_instr')
PATH_SAVE_BAR = '/Users/sumuzhao/Downloads/MIDI/jazz/jazz_test/tracks/data_bar'
PATH_SAVE_PHR = '/Users/sumuzhao/Downloads/MIDI/jazz/jazz_test/tracks/data_phr'
TRA_SIZE = 70
VAL_SIZE = 10
SAMPLE_RATIO = 0.5
prefix = ['Bass', 'Drum', 'Guitar', 'Other', 'Piano', 'instr_act']

song_list = [f.split('.')[0] for f in listdir(PATH_SEG) if isfile(join(PATH_SEG, f))]
...
def save_phrases(rnd_list, save_dir='tr'):
    ...
    for song_idx in range(len(rnd_list)):
        msd_id = song_list[rnd_list[song_idx]]
