...
parser.add_argument('--dataset_A_dir', dest='dataset_A_dir', default='Dataset (use directly)/JC_J', help='path of the dataset of domain A')
parser.add_argument('--dataset_B_dir', dest='dataset_B_dir', default='Dataset (use directly)/JC_C', help='path of the dataset of domain B')
